...
class _UserSatatusWidgetState extends State<UserSatatusWidget> {
  ...
  @override
  void initState() {
    context.read<UserExtandProvider>().reset();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<GazeTrackerProvider>(
        ...
        builder: (context, child) {
          ...
          return Consumer<UserExtandProvider>(
              builder: (context, userExtendProvider, child) {
            return Stack(
              children: [
                Scaffold(
                  ...
                  body: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Center(
                            child: Text(
                              'Count :- ${userExtendProvider.counterAdd}',
                              style: const TextStyle(
                                fontSize: 20,
                                color: Colors.white,
                              ),
